...
/**
 * Creates a virtual module called `@remix-run/shared-internals/server-build` that exports the
...
${Object.keys(config.routes)
  .map((key, index) => {
    ...
    // typed in `packages/remix-shared-internals/server-build.ts` to avoid tsc errors.
