...
module.exports = function rollup() {
  let sourceDir = "packages/remix-shared-internals";
  ...
  return [
    {
      ...
      output: {
        banner: createBanner("@remix-run/shared-internals", version),
        dir: outputDist,
        format: "cjs",
      ...
      output: [
        {
          ...
          banner: createBanner("@remix-run/shared-internals", version, true),
          dir: outputDir,
          format: "cjs",
        },
        {
